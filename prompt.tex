...
% Margin-safe verbatim settings: force breaking even on strings with no
% spaces (long identifiers, texttt-style tokens, etc.) and use a slightly
% smaller font so long lines never overflow the text width.
\fvset{
    breaklines=true,
    breakanywhere=true,
    breaksymbolleft={},
